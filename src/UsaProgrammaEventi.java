...
public class UsaProgrammaEventi {
    ...
    public static void main(String[] args) throws Exception {
        ...
        LocalDate date2 = LocalDate.of(2025, 3, 8);
        Evento evento2=new Evento("Battesimo", date2, 120);

        LocalDate date3 = LocalDate.of(2025, 3, 31);
        Evento evento3=new Evento("Compleanno", date3, 120);

        LocalDate date4 = LocalDate.of(2025, 3, 31);
        Evento evento4=new Evento("Matrimonio", date4, 120);

        LocalDate date5 = LocalDate.of(2025, 3, 31);
        ...
        LocalDate dateControllo = LocalDate.of(2025, 3, 31);
